...
class App extends React.Component<any, any> {
  ...
  public getAccountNFTs = async () => {
    const { address, chainId } = this.state;
    this.setState({ fetching: true });
    try {
      // get account balances
      const NFTs = await apiGetAccountNFTs(address, chainId);

      await this.setState({ fetching: false, address, NFTs });
    } catch (error) {
      console.error(error);
      await this.setState({ fetching: false });
    }
          ...
          <SContent>
            ...
            {!address && !assets.length ? (
              ...
              <SBalances>
                ...
                <Column center>
                  {!fetching ? (
                      <AccountNFTs nft_uri_list={nft_uri_list} />
                  ) : (
                      <Column center>
                        <SContainer>
                          <Loader />
